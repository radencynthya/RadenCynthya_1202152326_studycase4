...
public class ListNamaMhsActivity extends AppCompatActivity {
    ...
    class getData extends AsyncTask<String, Integer, String> {
        ...
        public getData(ListView listMhs) {
            ...
            dialog = new ProgressDialog(ListNamaMhsActivity.this);
        ...
        protected String doInBackground(String... strings) {
            adapter = new ArrayAdapter<>(ListNamaMhsActivity.this, android.R.layout.simple_list_item_1, listNama); //membuat adapter
